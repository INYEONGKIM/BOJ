#include<stdio.h>
        ...
        /*                                                                          8R1OJbC,E)rYv)s              */
       /*                                                                        x=WFrzP%J@++4o$oDMhMv            */
       /*                                                                     D]d4r]!e]EEbEm,2RA$$MmLUKMA         */
      /*                                                                     /Kqk.Xa[.kh.wg)k,DZEr%N%9}V]C         */
      /*                                                                   98!Y^TPgTR&uAjDBNZthChr1]%PztG*Su       */
      /*                                                                 KH0&=LI>u{g<]Dl@4*)a&)I!nI0)%Wxf1WxNc     */
     /*                                                                 7b*3]1T430kbU2c1x*EY.<W{L*[oN?[l#rK=%.I     */
     /*                                                                t0B$i}>Js,@LIYOk2chIZAOb>EjdCc^$l@f3!HZ$A    */
    /*                                                                z(4sPmL7{j%3.rhVh1AiV]%9*7.Laa!!xy8V1bc*$t9    */
    /*                                                               J7KHs[roz$^ph+4proH.,3bZr}%)/]9LJD}*{$)]VxMq*   */
    /*                                                              lhd3aCbuqD,Y]i{w<dl67n*2x}lG3w1.k8HK?G)S/Dzl@wk  */
   /*                                                              (j?kde<X<**I>*Y8WBaJF{]nJ78DOpP[tc@C0$*@)$03+c[T0  */
   /*                                                              &DI]AA0>hT.6$!],xLw<On4uEpFC*{Aq1D2xliVp,Vk!>uq+d  */
   /*                                                             w4**Ita6rV}SujvTvBaM6JutDNOF9).l4F9hjMx7L]1O4%rDE,A */
  /*                                                              DTE1h^,V7f^5t/#OwDbF8ljO8WSgCiwluq04,H?)*ZpuExEut+Z  */
  /*                                                             =]Yr**CE1T+eB4>390,t,Aqjh+,{qOxD4]]@(&eoa9+GH8QdJLd>7 */
  /*                                                            &@tdoQ{z<5g)1lJqB5%M%)Ht+YdV0&Ojc7r0xL@rt/rXHtIVO4I7Fu1*/
  /*                                                            >rZMZ=#L^Tk?mZ+)B!fNfNuCgX{iJd,j%p.8?CR=tQ?cZAWfW*bj7V%*/
  /*                                                            $w<Yz$%WT5!zv4Q&}3r<rR(+@].f6Exd9H+D1uCcW/$X$>j9H!Fo=%0*/
 /*                                                            }u<fMt5bOL4uxL{iy3eC1HE[k6@1*/#define found he/*u{4WouYRU*/
 /*                                                            >Oix7S5pe^O8G0imoi!f@.N@C1L<e$4zgjuJKbk1GK&gKL^xZ!f$WFxi?*/
 /*                                                            Cy8C%.q3*/char *prob = "70i02@67H07P6dQb3@7e"/*,O9{hWab*]*/
 /*                                                           fOW&O7KSY527cc{.B&Ah3h%2l7ucdOuqWH^T4YghdAr^pchDw>9Z^xkz]{*/
 /*                                                           A]m=EJw&0*/"Rb3X7eOfaY64TceG5dyd4r5dr1bL10^21H";/*4LhYg5jO*/
 /*                                                           WW%}c{@6qj!nj@LaTO&Mh9$Z!fV<q4{&Dz6&n=3aO.b+I$#(.wF{upfOnI*/
 /*                                                           Aq??JM9lqp$jN6&69O1Q=]5eY<)E8L4!Hr1$4*JiS!qa*mHq&aq>=l/f2z*/
 /*                                                           F$MLL=?7f.*i$hR^}tVch.$4)<*YCx3t+k?tv<D%(2YE9xET<0[5i.MEpg*/
 /*                                                           ].*/pr(char *, int *); hehe(){int k=0; pr(prob,&k); }/*iQh*/
 /*                                                           RmQJ}A4Ec/$JOH&Cf+96lb6pAY<9CY)H{ht&O>Y67$Ad&WIDac@]qtjpDm*/
/*                                                           &?csg.0&>ak]F&C@H3.LmeY])fulxLh>]qE3rN,ndO.{q$}UpV&#rYE$iJKH*/
...
x=int(__import__('sys').stdin.readline());print(111*x*x+11*x+1)
