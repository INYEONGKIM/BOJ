...
for x in l:
    ...
    for cm in cmd:
        ...
        if x[1] == c[1]: s += 1
        if x[2] == c[2]: s += 1
        if x[0] == c[1] or x[0] == c[2]: b += 1
        if x[1] == c[0] or x[1] == c[2]: b += 1
        if x[2] == c[0] or x[2] == c[1]: b += 1
